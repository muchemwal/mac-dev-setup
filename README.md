...
[![Build Status](https://travis-ci.com/muchemwal/mac-dev-setup.svg?branch=master)](https://travis-ci.com/muchemwal/mac-dev-setup)
...
# Launch installation
```shell
curl https://raw.githubusercontent.com/muchemwal/mac-dev-setup/master/src/mac-dev-setup.sh | bash
```
...
- ## GIT
  ...
  - ### [git-alias](https://github.com/muchemwal/gitalias)
    ...
    There is a lot more you should check [https://github.com/muchemwal/gitalias](https://github.com/muchemwal/gitalias) to see the list of available aliases.
